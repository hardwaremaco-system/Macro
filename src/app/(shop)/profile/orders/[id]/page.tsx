...
export default function OrderDetailsPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 print:p-0 print:py-0">
      ...
      <div className="flex items-center justify-between mb-8 print:hidden">
        ...
        <button 
          ...
          className="bg-slate-900 text-white px-4 py-2 rounded-lg text-sm font-bold hover:bg-slate-800 transition-colors flex items-center shadow-sm"
        >
