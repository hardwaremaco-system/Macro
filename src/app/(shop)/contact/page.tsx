...
export default function ContactPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20 lg:py-24">
      ...
      {/* Page Header - Left Aligned, scales up for desktop */}
      <div className="max-w-3xl mb-12 md:mb-16 lg:mb-20 text-left">
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-gray-900 mb-6 lg:mb-8 leading-tight tracking-tight">
          <span className="block">Welcome to the</span>
          <span className="block text-blue-600">Contact Us Page</span>
        </h1>
        <ul className="list-disc pl-5 text-gray-600 space-y-3 text-lg md:text-xl lg:leading-relaxed">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 xl:gap-16">
        ...
        {/* Contact Information (Takes up 4 columns on desktop) */}
        <div className="lg:col-span-4 space-y-8">
          <div className="bg-gray-50 p-6 sm:p-8 lg:p-10 rounded-2xl lg:rounded-3xl border border-gray-200 shadow-sm h-full">
            <h3 className="text-xl md:text-2xl font-black mb-8 border-b border-gray-200 pb-4 text-blue-600 tracking-tight">
              Store Details
            </h3>

            <div className="space-y-8">
              <div>
                <h4 className="font-bold text-gray-900 mb-2 text-base md:text-lg">Our Location</h4>
                <p className="text-gray-600 text-sm md:text-base leading-relaxed">Main Street, Kabale Town<br/>Western Region, Uganda</p>
              </div>

              <div>
                <h4 className="font-bold text-gray-900 mb-2 text-base md:text-lg">Phone & WhatsApp</h4>
                <p className="text-gray-600 text-sm md:text-base">+256 700 000 000</p>
              </div>

              <div>
                <h4 className="font-bold text-gray-900 mb-2 text-base md:text-lg">Email</h4>
                <p className="text-gray-600 text-sm md:text-base">support@macrohardware.com</p>
              </div>

              <div>
                <h4 className="font-bold text-gray-900 mb-2 text-base md:text-lg">Working Hours</h4>
        ...
        {/* Contact Form (Takes up 8 columns on desktop) */}
        <div className="lg:col-span-8">
          <div className="bg-white rounded-2xl lg:rounded-3xl shadow-lg border border-gray-100 p-6 sm:p-8 md:p-10 lg:p-12 h-full">
            <h3 className="text-2xl md:text-3xl font-black text-blue-600 mb-8 tracking-tight">
              Send us a Message
            </h3>

            {/* Success Message */}
            {status === 'success' && (
              <div className="bg-green-50 text-green-700 p-4 rounded-xl mb-8 border border-green-200 font-bold flex items-center md:text-lg">
            ...
            {/* Error Message */}
            {status === 'error' && (
              <div className="bg-red-50 text-red-700 p-4 rounded-xl mb-8 border border-red-200 flex flex-col items-start text-sm">
