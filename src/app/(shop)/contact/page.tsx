...
export default function ContactPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20 lg:py-24">
      ...
      {/* Page Header - Centered with Side-by-Side Bullet Points */}
      <div className="max-w-4xl mx-auto mb-12 md:mb-16 lg:mb-20 text-center">
        ...
        {/* Centered container for left-aligned, 2-column bullet points */}
        <div className="flex justify-center">
          <ul className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-4 text-left text-gray-600 text-lg md:text-xl list-disc pl-5">
      ...
      <div className="bg-gray-50 p-6 sm:p-8 lg:p-10 rounded-2xl lg:rounded-3xl border border-gray-200 shadow-sm mb-12 lg:mb-16">
        <h3 className="text-xl md:text-2xl font-black mb-8 border-b border-gray-200 pb-4 text-blue-600 tracking-tight text-center">
          Store Details
        </h3>
      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-2xl lg:rounded-3xl shadow-lg border border-gray-100 p-6 sm:p-8 md:p-10 lg:p-12">
          <h3 className="text-2xl md:text-3xl font-black text-blue-600 mb-8 tracking-tight text-center md:text-left">
            Send us a Message
          </h3>
